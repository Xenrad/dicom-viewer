  ...
  return (
    <div className={computedView && 'ohif-disabled'}>
      ...
      <div className="mt-3 flex justify-between">
        <IconButton
          className="bg-customblue-30 h-[26px] w-[58px] rounded-[4px] !text-black"
          onClick={() => onPlayPauseChange(!isPlaying)}
        >
          <Icon
            name={getPlayPauseIconName()}
            className=" active:text-primary-light hover:bg-customblue-300 text-black h-[24px] w-[24px] cursor-pointer"
          />
        </IconButton>
        <InputNumber
