    ...
    <div className={`flex select-none items-center space-x-2 ${containerClassName ?? ''}`}>
      ...
      >
        <div
          ...
          style={{
            background: `linear-gradient(to right, #323132 0%, #323132 ${rangeValuePercentageStart}%, #5acce6 ${rangeValuePercentageStart}%, #5acce6 ${rangeValuePercentageEnd}%, #323132 ${rangeValuePercentageEnd}%, #323132 100%)`,
          }}
        ></div>
        <div
