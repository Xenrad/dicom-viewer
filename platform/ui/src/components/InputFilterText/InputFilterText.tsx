  ...
  return (
    <label className={classNames('relative', className)}>
      ...
      <input
        ref={searchInputRef}
        type="text"
        className="border-primary-light focus:border-inputfield-focus disabled:border-inputfield-disabled placeholder:text-inputfield-placeholder block w-full appearance-none rounded-md border bg-black py-2 px-9 text-base leading-tight shadow transition duration-300 focus:outline-none"
      ...
      <span className="absolute inset-y-0 right-0 flex items-center pr-2">
        <Icon
          ...
          className={classNames('cursor-pointer border-primary-light', filterValue ? '' : 'hidden')}
          onClick={() => {
