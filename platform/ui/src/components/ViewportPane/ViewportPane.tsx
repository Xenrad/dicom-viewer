  ...
  return (
    <div
      ...
      className={classnames(
        ...
        {
          'border-primary-light/50 border-2': isActive,
          'border-3 border-transparent': !isActive,
        },
        className
      )}
      style={{
    ...
    >
      <div
        className={classnames(
          'h-full w-full overflow-hidden rounded-md border-[#323132]',
          {
            'border-0': isActive,
            'group-hover:border-3 border-2': !isActive,
          },
          className
        )}
      >
